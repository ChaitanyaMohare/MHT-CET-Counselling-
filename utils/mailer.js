...
const sendQuickLeadThankYou = async (toEmail, studentName, details = {}) => {
  ...
  await resend.emails.send({
    from: 'Pravesh Mitra <onboarding@resend.dev>',
    to: toEmail,
    subject: '🎓 Thank You for Choosing Pravesh Mitra!',
    html: `
<!DOCTYPE html>
<html lang="en">
...
<body style="margin:0;padding:0;background:#f1f5f9;font-family:'Segoe UI',Arial,sans-serif;">
  <div style="max-width:600px;margin:40px auto;background:#fff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
    ...
    <div style="background:linear-gradient(135deg,#1a56db 0%,#3730a3 100%);padding:36px 40px;text-align:center;">
      <h1 style="color:#fff;margin:0;font-size:1.7rem;font-weight:800;">Pravesh Mitra</h1>
    ...
    <div style="padding:36px 40px;">
      ...
      <p style="color:#374151;line-height:1.7;margin:0 0 20px;">
        Thank you for filling out the quick form on <strong>Pravesh Mitra</strong>. We're thrilled you've chosen us for your <strong>MHT-CET counselling journey</strong>!
      </p>

      <div style="background:#f8fafc;border:1.5px solid #e2e8f0;border-radius:10px;padding:20px 24px;margin-bottom:24px;">
        <p style="margin:0 0 12px;font-size:0.78rem;font-weight:700;color:#94a3b8;text-transform:uppercase;">Your Submission Summary</p>
        ${mhtCetScore ? `
        <div style="display:flex;justify-content:space-between;padding:8px 0;border-bottom:1px solid #e2e8f0;">
          <span style="color:#64748b;font-size:0.88rem;">MHT-CET Score</span>
          <strong style="color:#1a56db;">${mhtCetScore}</strong>
        </div>` : ''}
      ...
      <div style="background:linear-gradient(135deg,rgba(26,86,219,0.06),rgba(124,58,237,0.06));border:1.5px solid rgba(26,86,219,0.15);border-radius:10px;padding:20px 24px;margin-bottom:28px;">
        <p style="margin:0 0 12px;font-weight:700;color:#0a0f2e;">📋 What Happens Next?</p>
        <p style="margin:0 0 8px;color:#374151;font-size:0.85rem;line-height:1.6;"><strong style="color:#1a56db;">1.</strong> Browse our counselling plans and choose the one that fits your needs.</p>
        <p style="margin:0 0 8px;color:#374151;font-size:0.85rem;line-height:1.6;"><strong style="color:#1a56db;">2.</strong> Complete your registration and payment.</p>
        <p style="margin:0;color:#374151;font-size:0.85rem;line-height:1.6;"><strong style="color:#1a56db;">3.</strong> Our expert counsellor will call you within <strong>24 hours</strong>.</p>
      </div>

      <div style="text-align:center;margin-bottom:28px;">
        <a href="https://praveshmitra.online/packages"
           style="display:inline-block;background:linear-gradient(135deg,#1a56db,#3730a3);color:#fff;padding:14px 36px;border-radius:8px;text-decoration:none;font-weight:700;">
      ...
      <div style="text-align:center;padding:16px;background:#f8fafc;border-radius:8px;">
        <p style="margin:0;color:#64748b;font-size:0.85rem;">
          ...
          💬 <a href="https://wa.me/919529679073" style="color:#16a34a;text-decoration:none;font-weight:600;">Chat on WhatsApp</a>
        </p>
      </div>
    </div>
